...
CREATE OR REPLACE TABLE B2B_REVENUE (
...
CREATE OR REPLACE TABLE MM_JOURNEY (
...
CREATE OR REPLACE TABLE DAILY_LOAD (
...
CREATE OR REPLACE TABLE WEIGHTED_UTILIZATION (
    "ss" VARCHAR, "aa" VARCHAR, "Start Date Day" VARCHAR,
    "Start Date" VARCHAR, "Close Date" VARCHAR,
    "connectionid" VARCHAR, "TripSheetNo" VARCHAR,
    "stoppointorder" VARCHAR, "Final connection name" VARCHAR,
    "Lane" VARCHAR, "route_type" VARCHAR, "load_unloadcity" VARCHAR,
    "vehiclename" VARCHAR, "Phy Wt" VARCHAR,
    "Phy wt Ecomm" VARCHAR, "Phy wt Cargo" VARCHAR,
    "Vol Wt" VARCHAR, "Vol wt Ecomm" VARCHAR,
    "Vol wt Cargo" VARCHAR, "Chg Wt" VARCHAR,
    "Chg wt Ecomm" VARCHAR, "Chg wt Cargo" VARCHAR,
    "Phy Cap" VARCHAR, "Vol Cap" VARCHAR, "Chg Cap" VARCHAR,
    "Dist." VARCHAR, "LU_Phy" VARCHAR, "LU_Vol" VARCHAR,
    "LU_Chg" VARCHAR, "WC_Phy" VARCHAR, "WC_Vol" VARCHAR,
    "WC_Chg" VARCHAR, "WA_Phy" VARCHAR, "WA_Vol" VARCHAR,
    "WA_Chg" VARCHAR, "WU_Phy" VARCHAR, "WU_Vol" VARCHAR,
    "WU_Chg" VARCHAR, "Cost Leg wise" VARCHAR,
    "LPK_Phy" VARCHAR, "LPK_Vol" VARCHAR, "LPK_Chg" VARCHAR,
    "TC_Phy" VARCHAR, "TC_Vol" VARCHAR, "TC_Chg" VARCHAR,
    "CD_Phy" VARCHAR, "CD_Vol" VARCHAR, "CD_Chg" VARCHAR,
    "Trip Cost" VARCHAR, "Dist Sum" VARCHAR,
    "IGN_Phy_wt_Ecomm" VARCHAR, "IGN_Phy_wt_Cargo" VARCHAR,
    "IGN_Vol_wt_Ecomm" VARCHAR, "IGN_Vol_wt_Cargo" VARCHAR,
    "IGN_Phy_Cap" VARCHAR, "IGN_Vol_Cap" VARCHAR,
    "IGN_Chg_Cap" VARCHAR, "IGN_Phy_Wt" VARCHAR,
    "IGN_Vol_Wt" VARCHAR, "IGN_Chg_Wt" VARCHAR,
    "Vendor_Name" VARCHAR, "Start" VARCHAR, "Close" VARCHAR,
    "Dedicated Route as per Mapping" VARCHAR,
    "Cost_sharing" VARCHAR, "New_trip_cost" VARCHAR,
    "Vehicle_Volume" VARCHAR, "vehicle_hired" VARCHAR,
    "Cargo Cost" VARCHAR, "Ecom Cost" VARCHAR,
    "PK_at_90%" VARCHAR, "Cargo Cost on billed weight" VARCHAR,
    "Start date Month" VARCHAR, "Start date Year" VARCHAR,
    "Ecom ComP" VARCHAR, "Cargo comp" VARCHAR,
    "Ecom_vol_Cap" VARCHAR, "Cargo_Vol_Cap" VARCHAR,
    "TTL_Vol_Cap" VARCHAR, "Min_Vol_Cap" VARCHAR,
    "Max_Vol_Cap" VARCHAR, "route mode" VARCHAR
);

CREATE OR REPLACE TABLE DIM_HUB_CITY (
    "HubName" VARCHAR, "HubState" VARCHAR,
    "HubCity" VARCHAR, "Territory" VARCHAR
);

CREATE OR REPLACE TABLE DIM_HUB_TO_ZONE (
