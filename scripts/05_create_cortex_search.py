import snowflake.connector, os, csv, io
...
if not os.path.exists(guide_path) or not os.path.exists(prompt_path):
    print(f"ERROR: Place 'XB Guide FINAL.docx' and 'XB Prompt FINAL.docx' in current directory")
    print(f"Or set XB_GUIDE_PATH and XB_PROMPT_PATH environment variables")
    exit(1)
